...
namespace FirstGitHubProject.Features
{
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "TMFeature", "As a TurnUp Portal admin, I would like to create , edit and delete time and mater" +
                    "ial records so that I can manage \r\nemployees time and materials successfully", ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
#line 11
 testRunner.Then("Then the record should be created successfully", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
        ...
        [NUnit.Framework.TestCaseAttribute("Time", "Tripti", "$30.00", null)]
        [NUnit.Framework.TestCaseAttribute("Material", "mouse", "$40.00", null)]
...
#line hidden
#line 16
 testRunner.And(string.Format("I edited \'{0}\',\'{1}\' and \'{2}\'on an existing time and material record", description, code, price), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 17
 testRunner.Then(string.Format("The record should be editted successfully\'{0}\',\'{1}\' and \'{2}\'", description, code, price), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
